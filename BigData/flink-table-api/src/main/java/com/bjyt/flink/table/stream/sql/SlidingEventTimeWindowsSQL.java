...
public class SlidingEventTimeWindowsSQL {
   public static void main(String[] args)throws Exception{
     ...
     SingleOutputStreamOperator<Row> waterMarksRow = rowDataStream.assignTimestampsAndWatermarks(
      ...
      //win.end 10000
      //win.rowtime 9999
      Table table = tableEnv.sqlQuery("SELECT uid,SUM(money),HOP_END(rowtime,INTERVAL '2' SECOND,INTERVAL '10' SECOND) as widEnd FROM t_orders GROUP BY HOP(rowtime,INTERVAL '2' SECOND,INTERVAL '10' SECOND),uid");
      //2 is step instance,10 is windows instance
      /*u1,5.0,1970-01-01 00:00:02.0
       *u1,15.0,1970-01-01 00:00:04.0
       *u2,8.0,1970-01-01 00:00:04.0
       */
