...
public class OperatorState {
  public static void main(String[] args) throws Exception {
    ...
    DataStreamSource<Tuple2<String, String>> tp = env.addSource(new MyParFileSource("/flink-1.10.0-bin-scala_2.11/flink-1.10.0/data/input/offset"));
    /*
     2> (1,1)
     1> (0,a)
     2> (1,2)
     ...
     */
    /*
     * if has exception, will restart 2 time, then read data from line 1, read data multiple times
