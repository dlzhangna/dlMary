...
public class EventTimeSessionWindow {
	public static void main(String[] args) throws Exception {
		  ...
		  /*
		   >1575017261000,spark,1
           >1575017262000,spark,1
           >1575017267000,spark,1
           >1575017272000,spark,1
           >1575017280000,spark,2
		  */
...
//		  //divide Tumbing window
		  WindowedStream<Tuple3<String,String,Integer>,Tuple,TimeWindow> window = keyed.window(EventTimeSessionWindows.withGap(Time.seconds(5)));
